...
def register_user(request):
    if request.method =='POST':
        ...
        if form.is_valid():
            ...
            messages.add_message(request,messages.ERROR,'Please verify your details')
    ...
    if request.method =='POST':
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                messages.add_message(request,messages.ERROR,'Please provide correct redentials')
...
def add_to_cart(request,product_id):
    ...
    if check_item_presence:
        ...
        if cart:
            ...
            messages.add_message(request,messages.ERROR,'Failed to add product in the cart')
            return redirect('/cart')
...
def esewa_verify(request):
    ...
    status=root[0].text.split()
    if status== 'Success':
        order_id=o_id.strip("_")[0]
    ...
    if request.method =='POST' :
        ...
        if form.is_valid():
            ...
            return redirect('/profile')
             ...
             messages.add_message(request,messages.ERRORS,'Failed toUpdate Profile') 
